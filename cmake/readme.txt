...
# If you want set the VCPKG_DEFAULT_TRIPLET variable
On command line
---------------
...
# If you have NOT set VCPKG_DEFAULT_TRIPLET variable the do these see (# If you want set the VCPKG_DEFAULT_TRIPLET variable) otherwise use  below
